...
<img src={require('../../static/img/sashakt/tag-management.png').default} alt="Tag Management row showing Difficulty Level with Medium, Hard, Easy tags" width="700" />
...
<img src={require('../../static/img/sashakt/test-primary-details.png').default} alt="Primary Details form with Test Name, Description, Tag Types, Tags and Test Status fields" width="700" />
...
<img src={require('../../static/img/sashakt/question-auto-selection.png').default} alt="Auto Selection panel showing tags Easy and Pedagogy with number of questions per tag" width="650" />
...
<img src={require('../../static/img/sashakt/question-manual-selection.png').default} alt="Manual Selection panel showing question list with answers and tags columns" width="650" />
...
<img src={require('../../static/img/sashakt/candidate-experience.png').default} alt="Candidate Experience panel showing Pre-test Guidelines, Test Completion Message, Language, Candidate Information Form and Certificate fields" width="650" />
...
<img src={require('../../static/img/sashakt/test-rules.png').default} alt="Test Rules panel showing toggle options for shuffle, show marks, and show result" width="550" />
...
<img src={require('../../static/img/sashakt/test-actions.png').default} alt="Test action menu showing Edit, Download QR, Duplicate, Copy Test Link, View Report and Delete options" width="450" />
