...
<img src={useBaseUrl('/img/sashakt/tag-management.png')} alt="Tag Management row showing Difficulty Level with Medium, Hard, Easy tags" width="800" />
...
<img src={useBaseUrl('/img/sashakt/test-primary-details.png')} alt="Primary Details form with Test Name, Description, Tag Types, Tags, District and Test Status fields" width="800" />

<img src={useBaseUrl('/img/sashakt/test-district-dropdown.png')} alt="District dropdown with searchable list of districts" width="400" />

<img src={useBaseUrl('/img/sashakt/test-state-dropdown.png')} alt="State dropdown with searchable list of states" width="400" />
...
<img src={useBaseUrl('/img/sashakt/question-auto-selection.png')} alt="Auto Selection panel showing tags Easy and Pedagogy with number of questions per tag" width="700" />
...
<img src={useBaseUrl('/img/sashakt/question-manual-selection.png')} alt="Manual Selection panel showing question list with answers and tags columns" width="700" />
...
<img src={useBaseUrl('/img/sashakt/candidate-experience.png')} alt="Candidate Experience panel showing Pre-test Guidelines, Test Completion Message, Language, Candidate Information Form and Certificate fields" width="850" />
...
<img src={useBaseUrl('/img/sashakt/test-rules.png')} alt="Test Rules panel showing toggle options for shuffle, show marks, and show result" width="700" />
...
<img src={useBaseUrl('/img/sashakt/template-search.png')} alt="Template search bar with filters for states, districts, tag types and tags" width="700" />
...
<img src={useBaseUrl('/img/sashakt/test-actions.png')} alt="Test action menu showing Edit, Download QR, Duplicate, Copy Test Link, View Report and Delete options" width="500" />
...
<img src={useBaseUrl('/img/sashakt/create-user-btn.png')} alt="Users page header with Create User button" width="350" />
...
<img src={useBaseUrl('/img/sashakt/create-user.png')} alt="Create User form with Name, Email, Phone Number, Password, Role and User Status fields" width="600" />
...
<img src={useBaseUrl('/img/sashakt/org-details.png')} alt="Organisation Details page" width="700" />
...
<img src={useBaseUrl('/img/sashakt/org-settings.png')} alt="Organisation Settings page" width="700" />
...
<img src={useBaseUrl('/img/sashakt/platform-nomenclature.png')} alt="Platform Nomenclature settings page" width="700" />
