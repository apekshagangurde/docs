...
<img src={require('../../static/img/sashakt/create-tag-type-btn.png').default} alt="Create Tag Type button" width="350" />

<img src={require('../../static/img/sashakt/tag-management.png').default} alt="Tag Management row showing Difficulty Level with Medium, Hard, Easy tags" width="800" />
...
<img src={require('../../static/img/sashakt/question-bank-buttons.png').default} alt="Create Question and Bulk Upload buttons" width="450" />

3. Choose question type from the options given

<img src={require('../../static/img/sashakt/question-type.png').default} alt="Choose Question Type dialog showing Commonly Used and Advanced options" width="500" />

4. Enter the following details:

<img src={require('../../static/img/sashakt/question-settings.png').default} alt="Question Settings form with question text and answer options" width="650" />

<img src={require('../../static/img/sashakt/question-answer-settings.png').default} alt="Answer Settings with options A, B, C, D and correct answer selection" width="650" />

<img src={require('../../static/img/sashakt/question-tags-marking.png').default} alt="Tag Types, Tags, State selection and Marking Scheme panel" width="650" />
...
<img src={require('../../static/img/sashakt/form-field-types.png').default} alt="Choose Field Type panel showing Commonly Used, General, and Choice List options" width="500" />
...
<img src={require('../../static/img/sashakt/test-primary-details.png').default} alt="Primary Details form with Test Name, Description, Tag Types, Tags, District and Test Status fields" width="800" />

<img src={require('../../static/img/sashakt/test-district-dropdown.png').default} alt="District dropdown with searchable list of districts" width="400" />

<img src={require('../../static/img/sashakt/test-state-dropdown.png').default} alt="State dropdown with searchable list of states" width="400" />
...
<img src={require('../../static/img/sashakt/question-auto-selection.png').default} alt="Auto Selection panel showing tags Easy and Pedagogy with number of questions per tag" width="700" />
...
<img src={require('../../static/img/sashakt/question-manual-selection.png').default} alt="Manual Selection panel showing question list with answers and tags columns" width="700" />
...
<img src={require('../../static/img/sashakt/candidate-experience.png').default} alt="Candidate Experience panel showing Pre-test Guidelines, Test Completion Message, Language, Candidate Information Form and Certificate fields" width="850" />
...
<img src={require('../../static/img/sashakt/test-rules.png').default} alt="Test Rules panel showing toggle options for shuffle, show marks, and show result" width="700" />
...
<img src={require('../../static/img/sashakt/template-search.png').default} alt="Template search bar with filters for states, districts, tag types and tags" width="700" />
...
<img src={require('../../static/img/sashakt/test-actions.png').default} alt="Test action menu showing Edit, Download QR, Duplicate, Copy Test Link, View Report and Delete options" width="500" />
...
<img src={require('../../static/img/sashakt/create-user-btn.png').default} alt="Users page header with Create User button" width="350" />
...
<img src={require('../../static/img/sashakt/create-user.png').default} alt="Create User form with Name, Email, Phone Number, Password, Role and User Status fields" width="600" />
...
<img src={require('../../static/img/sashakt/org-details.png').default} alt="Organisation Details page" width="700" />
...
<img src={require('../../static/img/sashakt/org-settings.png').default} alt="Organisation Settings page" width="700" />
...
<img src={require('../../static/img/sashakt/platform-nomenclature.png').default} alt="Platform Nomenclature settings page" width="700" />
